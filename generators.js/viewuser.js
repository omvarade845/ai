...
const viewuser = async (ctx, userp) => {
  ...
  let time = joined.toLocaleString('en-US', { timeZone: 'Asia/Kolkata' });
  var text =
    ...
    `<b>💰 Balance: </b> <code>${balance} $rdm</code>\n` +
    ...
    `6. <i>Subscribe YouTube</i> ${done_youtube}\n` +
    `7. <i>Bind Wallet -</i> ${bind_wallet}`;
